    ...
    public static function addSection() {  
        ...
        \Redux::setSection(THEME_DOMAIN, [
            ...
            'fields' => [
                ...
                [
                    'id'       => 'styling_header_background-container-type',
                    'type'     => 'button_set',
                    'title'    => __('Background type', THEME_DOMAIN),
                    'subtitle' => __('No validation can be done on this field type', THEME_DOMAIN),
                    'options' => [
                ...
                [
                    ...
                    'required' => ['styling_header_background-container-type', '=', 'color']
                ],
                [
                    'id' => 'styling_header_background-container-pattern',
                    'type' => 'image_select',
                    'class' => 'them_patterns them_button_set',
                    'tiles' => true,
                    'options' => $patterns,
                    'default' => '01',
                    'required' => ['styling_header_background-container-type', '=', 'pattern']
                ],
                [
                    ...
                    'subtitle' => __('Body background with image, color, etc.', THEME_DOMAIN),
                    'desc'     => __('This is the description field, again good for additional info.', THEME_DOMAIN),
                    'required' => ['styling_header_background-container-type', '=', 'image']
                ],
                [
                ...
                [
                    'id'       => 'styling_header_background-menu-type',
                    'type'     => 'button_set',
                    'title'    => __('Background type', THEME_DOMAIN),
                    'subtitle' => __('No validation can be done on this field type', THEME_DOMAIN),
                    'options' => [
                ...
                [
                    ...
                    'required' => ['styling_header_background-menu-type', '=', 'color']
                ],
                [
                    'id' => 'styling_header_background-menu-pattern',
                    'type' => 'image_select',
                    'class' => 'them_patterns them_button_set',
                    'tiles' => true,
                    'options' => $patterns,
                    'default' => '01',
                    'required' => ['styling_header_background-menu-type', '=', 'pattern']
                ],
                [
                    ...
                    'subtitle' => __('Body background with image, color, etc.', THEME_DOMAIN),
                    'desc'     => __('This is the description field, again good for additional info.', THEME_DOMAIN),
                    'required' => ['styling_header_background-menu-type', '=', 'image']
                ],
                [
